...
if not isfolder("ToldeIsBest") then
makefolder("ToldeIsBest")
    
local Shadow = request({Url = "https://raw.githubusercontent.com/ToldeIsCool/Designs/main/ToldeShadow.png", Method = "GET"})
writefile("ToldeIsBest/Shadow.png", Shadow.Body)

local Chevron = request({Url = "https://raw.githubusercontent.com/ToldeIsCool/Designs/main/Chevron.png", Method = "GET"})
writefile("ToldeIsBest/Chevron.png", Chevron.Body)

local Circle = request({Url = "https://raw.githubusercontent.com/ToldeIsCool/Designs/main/Circle.png", Method = "GET"})
writefile("ToldeIsBest/Circle.png", Circle.Body)
end
...
local ToldeIsBest = Instance.new("ScreenGui")
ToldeIsBest.Name = HttpService:GenerateGUID(true)
ToldeIsBest.ZIndexBehavior = Enum.ZIndexBehavior.Global
ToldeIsBest.Parent = CoreGui
...
mainShadow.Image = getcustomasset("ToldeIsBest/Shadow.png")
...
sectionIcon.Image = getcustomasset("ToldeIsBest/Chevron.png")
...
dragIcon.Image = getcustomasset("ToldeIsBest/Circle.png")
...
dropdownIcon.Image = getcustomasset("ToldeIsBest/Chevron.png")
...
toggleInner.Image = getcustomasset("ToldeIsBest/Circle.png")
